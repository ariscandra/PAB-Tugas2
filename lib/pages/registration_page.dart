  ...
  void _submitForm() {
    ...
    if (!_agreeTerms) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Mohon centang persetujuan syarat dan ketentuan terlebih dahulu.'),
        ),
      );
      return;
    }
    ...
    if (provider.isEmailRegistered(_emailController.text)) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Alamat email ini sudah terdaftar. Gunakan email lain.'),
        ),
      );
      return;
    }
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8),
                        Text(
                          'Isi data diri kamu dengan lengkap untuk mendaftar sebagai peserta event.',
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      OutlinedButton(
                        ...
                        child: const Text('Reset formulir'),
                      ),
                      const SizedBox(height: 16),
                    ],
                  ),
